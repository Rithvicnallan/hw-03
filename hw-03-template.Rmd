...
model1 <- lm( educ ~ emailhr, data = gss16_advfront)

summary(model1)

```

By fitting a lm model and using the summary command we can derive a formula for the line-of-best fit:

emailhr = 13.79 + 0.042 * educ
